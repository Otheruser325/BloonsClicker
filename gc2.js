...
(function() {
  ...
  update_all_numbers = function() {
    ...
    if (("" + gens["monkey"].count).length >= langs[lang].monkeyr_abbrev_length + 2) {
      $("#monkey_counter").html("");
  ...
  */
  ...
  click2 = new Item("click2", 7);

  click2.unlock_condition = function() {
    return goomy.level >= 120;
  };
