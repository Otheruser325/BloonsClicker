...
var __apfx = ["", " thousand", " million", " billion", " trillion", " quadrillion", " quintillion", " sextillion", " septillion", " octillion", " nonillion", " decillion", " undecillion", " duodecillion", " tredecillion", " quattuordecillion", " quindecillion", " sexdecillion", " septendecillion", " octodecillion", " novemdecillion", " vigintillion", " unvigintillion", " duovigintillion", " tresvigintillion", " quattuorvigintillion", " quinvigintillion", " sexvigintillion", " septenvigintillion", " octovigintillion", " novemvigintillion", " trigintillion", "untrigintillion", "duotrigintillion", "trestrigintillion", "quattuortrigintillion", "quintrigintillion", "sextrigintillion", "septentrigintillion", "octotrigintillion", "novemtrigintillion", "quadragintillion"]
var __aspfx = ["", "K", "M", "B", "T", "Qa", "Qi", "Sx", "Sp", "Oc", "No", "Dc", "UD", "DD", "TD", "QaD", "QiD", "SxD", "SpD", "OcD", "NoD", "Vig", "UVi", "DVi", "TVi", "qVi", "QVi", "sVi", "SVi", "OVi", "NVi", "Tri", "UTri", "DTri", "TTr", "QaTr", "QiTr", "SxTr", "SpTr", "OcTr", "NoTr", "Qua"]

var __bpfx = ["", " million", " billion", " trillion", " quadrillion", " quintillion", " sextillion", " septillion", " octillion", " nonillion", " decillion", " undecillion", " duodecillion", " tredecillion", " quattuordecillion", " quindecillion", " sexdecillion", " septendecillion", " octodecillion", " novemdecillion", " vigintillion", " unvigintillion", " duovigintillion", " tresvigintillion", " quattuorvigintillion", " quinvigintillion", " sexvigintillion", " septenvigintillion", " octovigintillion", " novemvigintillion", " trigintillion"]
var __bspfx = ["", "M", "B", "T", "Qa", "Qi", "Sx", "Sp", "Oc", "No", "Dc", "UD", "DD", "TD", "QaD", "QiD", "SxD", "SpD", "OcD", "NoD", "Vig", "UVi", "DVi", "TVi", "qVi", "QVi", "sVi", "SVi", "OVi", "NVi", "Tri"]

var __sipfx = ["", "k", "M", "G", "T", "P", "E", "Z", "Y", "X", "W", "V", "U", "C", "kC", "MC", "GC", "TC", "PC", "EC", "ZC", "YC", "XC", "WC", "VC", "UC", "CC"]
...
function _reprnum_scientific(n){
	if(n < 1000000) return __digitgroup(n);
	var order = Math.floor(Math.log(n) / Math.log(10));
	var mantissa = n / Math.pow(10, order);
	return mantissa.toPrecision(6) + "e" + order;
}

function _reprnum_engineering(n){
	if(n < 1000000) return __digitgroup(n);
	var order = Math.floor(Math.log(n) / Math.log(10));
	var eng_order = Math.floor(order / 3) * 3;
	var mantissa = n / Math.pow(10, eng_order);
	return mantissa.toPrecision(6) + "e" + eng_order;
}

/* external exposed function */
this.reprnum = function(n, length){
	/* use a different locale depending on taste. */
	var format = (typeof settings !== "undefined" && settings.number_format) ? settings.number_format : "full";
	if(format == "scientific") return _reprnum_scientific(n);
	if(format == "engineering") return _reprnum_engineering(n);

	if(format == "small") length = length || "short";
	else if(format == "full") length = undefined;
