...
wiki_image = (filename) ->
	"https://bloons.fandom.com/wiki/Special:Redirect/file/#{filename}"
...
battle =
	...
	bloons: [
		...
		{name: "Yellow Bloon", hp: 50000, tap_reward: 0.02, bps_reward: 0.01, image: [wiki_image("BTD6YellowBloon.png"), wiki_image("Yellow_Bloon_BTD6.png"), bloon_image("%23ffd83f", "%23fff187")]}
		{name: "Pink Bloon", hp: 350000, tap_reward: 0.025, bps_reward: 0.0125, image: [wiki_image("BTD6PinkBloon.png"), wiki_image("Pink_Bloon_BTD6.png"), bloon_image("%23ff5fb7", "%23ff9fd4")]}
		{name: "Black Bloon", hp: 2500000, tap_reward: 0.03, bps_reward: 0.015, image: [wiki_image("BTD6BlackBloon.png"), wiki_image("Black_Bloon_BTD6.png"), bloon_image("%2324242a", "%23757582")]}
		{name: "White Bloon", hp: 15000000, tap_reward: 0.035, bps_reward: 0.0175, image: [wiki_image("BTD6WhiteBloon.png"), wiki_image("White_Bloon_BTD6.png"), bloon_image("%23f7f7f7", "%23c9d8ff")]}
		{name: "Lead Bloon", hp: 100000000, tap_reward: 0.04, bps_reward: 0.02, image: [wiki_image("BTD6LeadBloon.png"), wiki_image("Lead_Bloon_BTD6.png"), bloon_image("%23838383", "%23c8c8c8")]}
		{name: "Zebra Bloon", hp: 750000000, tap_reward: 0.045, bps_reward: 0.0225, image: [wiki_image("BTD6ZebraBloon.png"), wiki_image("Zebra_Bloon_BTD6.png"), bloon_image("%23ffffff", "%23161616")]}
		{name: "Rainbow Bloon", hp: 5000000000, tap_reward: 0.05, bps_reward: 0.025, image: [wiki_image("BTD6RainbowBloon.png"), wiki_image("Rainbow_Bloon_BTD6.png"), bloon_image("%23ff4646", "%23864cff")]}
		{name: "Ceramic Bloon", hp: 40000000000, tap_reward: 0.06, bps_reward: 0.03, image: [wiki_image("BTD6CeramicBloon.png"), wiki_image("Ceramic_Bloon_BTD6.png"), bloon_image("%23c7803c", "%23ffd17d")]}
		...
		{name: "BFB", hp: 2500000000000, tap_reward: 0.1, bps_reward: 0.055, image: wiki_image("BTD6BFB.png")}
		{name: "ZOMG", hp: 25000000000000, tap_reward: 0.13, bps_reward: 0.07, image: wiki_image("BTD6ZOMG.png")}
